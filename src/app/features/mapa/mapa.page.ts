...
export class MapaPage implements OnInit {
  ...
  constructor(private service: ParqueaderoService, private router: Router) {
    addIcons({
      searchOutline,
      optionsOutline,
      locationOutline,
  ...
  // ✅ ahora sí navega según el botón que presiones
  cambiarVista(v: string) {

  console.log("CLICK MENU:", v);

  const rutas: any = {
    mapa: '/app/tabs/mapa',
    reservas: '/app/tabs/historial',
    perfil: '/app/tabs/perfil'
  };

  console.log("NAVEGANDO A:", rutas[v]);

  this.router.navigateByUrl(rutas[v]);
